...
cd /home/ && ls -t /home/web*.tar.gz | head -1 | xargs -I {} sshpass -p PASSWORD scp -o StrictHostKeyChecking=no -P xx {} root@IP:/home/
echo "web备份文件远程备份完成"
cd /home/ && ls -t /home/certs*.tar.gz | head -1 | xargs -I {} sshpass -p PASSWORD scp -o StrictHostKeyChecking=no -P xx {} root@IP:/home/
echo "certs备份文件远程备份完成"
cd /home/ && ls -t /home/3x-ui*.tar.gz | head -1 | xargs -I {} sshpass -p PASSWORD scp -o StrictHostKeyChecking=no -P xx {} root@IP:/home/
echo "3x-ui备份文件远程备份完成"
cd /home/ && ls -t /home/root*.tar.gz | head -1 | xargs -I {} sshpass -p PASSWORD scp -o StrictHostKeyChecking=no -P xx {} root@IP:/home/
echo "root备份文件远程备份完成"
