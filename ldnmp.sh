...
EOF
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/twcoin/linux/main/wordpress.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/twcoin/linux/main/maccms.com.conf
